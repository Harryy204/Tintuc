    ...
    <nav class="navbar top-navbar navbar-toggleable-sm navbar-light">
        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="/backend/admin">
                ...
                <h4 class="text-white">Trang quản trị</h4>
            </a>
        </div>
        <!-- ============================================================== -->
        <!-- End Logo -->
        ...
        <div class="navbar-collapse">
            ...
            <ul class="navbar-nav my-lg-0">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link text-muted waves-effect waves-dark" href="{{route('be_profile', Auth::user()->id)}}" ><img src="{{(Auth::user()->avatar != '')?Auth::user()->avatar:'/frontend/template/assets/img/about/user.png'}}" alt="user" class="profile-pic m-r-10" style="width: 30px; height: 30px; border-radius: 50%"/>
