    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 col-8 align-self-center">
                <h3 class="text-themecolor m-b-0 m-t-0">Thông tin</h3>
                <ol class="breadcrumb">
                            ...
                            <center class="m-t-30" id="loadFormAvatar">
                                ...
                                <form method="post" action="{{route('be_profile.update_avt', $item->id)}}" enctype="multipart/form-data" id="uploadAvatar">
                                    ...
                                    <label for="avatar" class="" style="cursor: pointer;">
                                        <img src="{{($item->avatar)?$item->avatar:'/frontend/template/assets/img/about/user.png'}}" id="img-avatar" class="img-circle" width="150" style="width: 150px; height: 150px; border-radius: 50%" />
                                    </label>
                ...
                <div class="col-lg-8 col-xlg-9 col-md-7">
                    <div class="card">
                        <div class="card-block" id="loadFormDetailContent">
                            @foreach($user as $item)
                            <form class="form-horizontal form-material" method="post" action="" id="updateContentProfile">
                                @csrf
                                @method('PUT')
