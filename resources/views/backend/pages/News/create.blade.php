        ...
        <div class="row page-titles">
            <div class="col-md-5 col-8 align-self-center">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Tạo tin</li>
                </ol>
            </div>
            <div class="col-md-7 col-4 align-self-center">
                <a href="{{route('news.create')}}" class="btn waves-effect waves-light btn-danger pull-right hidden-sm-down"><i class="mdi mdi-plus mr-1"></i>Tạo danh mục</a>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
