    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 col-8 align-self-center">
                <h3 class="text-themecolor m-b-0 m-t-0">Tin tức</h3>
                <ol class="breadcrumb">
            ...
            <div class="col-md-7 col-4 align-self-center">
                <a href="{{route('news.create')}}" class="btn waves-effect waves-light btn-danger pull-right hidden-sm-down"><i class="mdi mdi-plus mr-1"></i>Tạo tin</a>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-block">
                        <h4 class="card-title d-flex align-items-center">
                            <span class="d-inline-block">Danh sách tin</span>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{route('news.destroy', $new->id)}}" method="post">
                                                <a href="{{route('news.edit', $new->id)}}" class="btn btn-primary w-100 mb-3"><i class="mdi mdi-lead-pencil mr-1"></i>Chinh sửa</a>
                                                @csrf
                                                @method('DELETE')
