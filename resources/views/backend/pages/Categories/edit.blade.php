    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 col-8 align-self-center">
                ...
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{url('categories')}}">Danh mục</a></li>
                    <li class="breadcrumb-item active">Cập nhật danh mục</li>
                </ol>
            </div>
            <div class="col-md-7 col-4 align-self-center">
                <a href="{{route('categories.create')}}" class="btn waves-effect waves-light btn-danger pull-right hidden-sm-down"><i class="mdi mdi-plus mr-1"></i>Tạo danh mục</a>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                            ...
                            <form method="post" action="{{route('categories.update', $category_item->id)}}">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="form-group mr-2 w-50">
                                        ...
                                        <input name="name" type="text" id="name" value="{{$category_item->name}}" class="form-control" placeholder="Nhập tên danh mục" />
                                    </div>
