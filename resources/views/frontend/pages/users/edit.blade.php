                        ...
                        <div class="col-lg-5">
                            <div class="card mb-5 mb-lg-0">
                                ...
                                <div class="card-body text-center">
                                    <img src="{{($item->avatar != '')?$item->avatar:'/frontend/template/assets/img/about/user.png'}}" alt="Image profile" id="img-avatar" width="30%" style="width: 100px; height: 100px; border-radius: 50%">
