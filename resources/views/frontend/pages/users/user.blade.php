                        ...
                        <div class="row py-4 align-items-end">
                            <div class="col-md-4">
                                <div class="image__profile">
                                    ...
                                    <a href="{{route('user.edit', $item->id)}}" class="btn btn-outline-profile">Chỉnh sửa thông tin</a>
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="desc__profile">
                                    ...
                                    <ul>
                                        <li><span>Địa chỉ:</span> {{($item->address != '')?$item->address:'Không có thông tin'}}</li>
                                        <li><span>Email:</span> {{($item->email != '')?$item->email:'Không có thông tin'}}</li>
                                        <li><span>Số điện thoại:</span> {{($item->phone != '')?$item->phone:'Không có thông tin'}}</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
